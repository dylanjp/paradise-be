...
class TaskServicePropertyTest {
    ...
    void todoTaskCreationIntegrity(
        ...
        TodoTask created = service.createTodoTask(userId, request, userId);
    ...
    void dailyTaskCreationIntegrity(
        ...
        DailyTask created = service.createDailyTask(userId, request, userId);
    ...
    void todoTaskUpdateIntegrity(
        ...
        service.createTodoTask(userId, createRequest, userId);

        // Update the task
        TodoTaskRequest updateRequest = new TodoTaskRequest(
                null, newDescription, null, newCompleted, newOrder, null
        );
        TodoTask updated = service.updateTodoTask(userId, requireNonNull(taskId), updateRequest, userId);
    ...
    void dailyTaskUpdateIntegrity(
        ...
        DailyTask created = service.createDailyTask(userId, createRequest, userId);
        ...
        DailyTask updated = service.updateDailyTask(userId, requireNonNull(taskId), updateRequest, userId);
    ...
    void userIsolation(
        ...
        service.createTodoTask(user1Id, todoRequest, user1Id);
        service.createDailyTask(user1Id, dailyRequest, user1Id);

        // Verify User2 cannot see User1's tasks via getAllTasksForUser
        UserTasksResponse user2Tasks = service.getAllTasksForUser(user2Id, user2Id);
        ...
        UserTasksResponse user1Tasks = service.getAllTasksForUser(user1Id, user1Id);
        ...
        assertThatThrownBy(() -> service.updateTodoTask(user2Id, requireNonNull(todoTaskId), updateTodoRequest, user2Id))
        ...
        assertThatThrownBy(() -> service.updateDailyTask(user2Id, requireNonNull(dailyTaskId), updateDailyRequest, user2Id))
                .isInstanceOf(TaskNotFoundException.class);
        
        // Verify User2 cannot delete User1's todo task
        assertThatThrownBy(() -> service.deleteTodoTask(user2Id, requireNonNull(todoTaskId), user2Id))
                .isInstanceOf(TaskNotFoundException.class);
        
        // Verify User2 cannot delete User1's Daily task
        assertThatThrownBy(() -> service.deleteDailyTask(user2Id, requireNonNull(dailyTaskId), user2Id))
                .isInstanceOf(TaskNotFoundException.class);
        
        // Verify User1's tasks are still intact after User2's failed attempts
        UserTasksResponse user1TasksAfter = service.getAllTasksForUser(user1Id, user1Id);
    ...
    void completionHistoryReturnsAllDatesInDescendingOrder(
        ...
        service.createDailyTask(userId, createRequest, userId);
        ...
        testService.createDailyTask(userId, request, userId);
        ...
        List<LocalDate> history = testService.getCompletionHistory(userId, requireNonNull(taskId), userId);
    ...
    void emptyCompletionHistoryReturnsEmptyList(
        ...
        // Get completion history
        List<LocalDate> history = service.getCompletionHistory(userId, requireNonNull(taskId), userId);
    ...
    void perfectDaysUserIsolation(
        ...
        List<LocalDate> user1PerfectDays = service.getPerfectDays(user1Id, year, user1Id);
        
        // Get perfect days for User2 - should be empty (task not completed)
        List<LocalDate> user2PerfectDays = service.getPerfectDays(user2Id, year, user2Id);
        ...
        List<LocalDate> user1PerfectDaysAfter = service.getPerfectDays(user1Id, year, user1Id);
        ...
        List<LocalDate> user2PerfectDaysAfter = service.getPerfectDays(user2Id, year, user2Id);
